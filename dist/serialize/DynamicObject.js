...
var DynamicObject = function (_GameObject) {
    ...
    function DynamicObject(id, position, velocity) {
        ...
        * @member {Number}
        */
        var _this = _possibleConstructorReturn(this, (DynamicObject.__proto__ || Object.getPrototypeOf(DynamicObject)).call(this, id));
