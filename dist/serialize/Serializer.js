...
class Serializer {
    ...
    static typeCanAssign(type) {
        return type !== _types2.default.CLASSINSTANCE && type !== _types2.default.LIST;
    }
    ...
    writeDataView(dataView, value, bufferOffset, netSchemProp) {
        if (netSchemProp.type == _types2.default.FLOAT32) {
            dataView.setFloat32(bufferOffset, value);
        } else if (netSchemProp.type == _types2.default.INT32) {
            dataView.setInt32(bufferOffset, value);
        } else if (netSchemProp.type == _types2.default.INT16) {
            dataView.setInt16(bufferOffset, value);
        } else if (netSchemProp.type == _types2.default.INT8) {
            dataView.setInt8(bufferOffset, value);
        } else if (netSchemProp.type == _types2.default.UINT8) {
            dataView.setUint8(bufferOffset, value);
        } else if (netSchemProp.type == _types2.default.STRING) {
            ...
            if (value === null) {
                ...
                for (let i = 0; i < strLen; i++) dataView.setUint16(bufferOffset + localBufferOffset + i * 2, value.charCodeAt(i));
            }
        } else if (netSchemProp.type == _types2.default.CLASSINSTANCE) {
            value.serialize(this, {
                dataBuffer: dataView.buffer,
                bufferOffset: bufferOffset
            });
        } else if (netSchemProp.type == _types2.default.LIST) {
            ...
            for (let item of value) {
                ...
                if (netSchemProp.itemType == _types2.default.CLASSINSTANCE) {
    ...
    readDataView(dataView, bufferOffset, netSchemProp) {
        ...
        if (netSchemProp.type == _types2.default.FLOAT32) {
            ...
            if (length === MAX_UINT_16) {
                ...
                let a = [];
                for (let i = 0; i < length; i++) a[i] = dataView.getUint16(bufferOffset + localBufferOffset + i * 2);
    ...
    getTypeByteSize(type) {
        ...
        switch (type) {
            case _types2.default.FLOAT32:
                {
                    return Float32Array.BYTES_PER_ELEMENT;
                }
            case _types2.default.INT32:
                {
                    return Int32Array.BYTES_PER_ELEMENT;
                }
            case _types2.default.INT16:
                {
                    return Int16Array.BYTES_PER_ELEMENT;
                }
            case _types2.default.INT8:
                {
                    return Int8Array.BYTES_PER_ELEMENT;
                }
            case _types2.default.UINT8:
                {
