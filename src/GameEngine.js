...
class GameEngine {
    ...
    /**
      ...
      * once on the server, and once on each client.  On the browser, the
      * GameEngine instance is available as window.LANCE.gameEngine
      *
    ...
    constructor(options) {
        ...
        // place the gameEngine in the globals
        if (typeof window !== 'undefined')
            window.LANCE = { gameEngine: this };
